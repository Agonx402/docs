...
This page is the fastest way to see the Agon protocol execute real settlements. It runs the committed devnet demo, which exercises every settlement path against the live V4 deployment and produces the benchmark artifacts used throughout these docs.
