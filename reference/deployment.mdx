...
| Gateway-channel collateral token | Official devnet USDC; resolve the `token_id` from `TokenRegistry` or `AGON_PROTOCOL_DEVNET_USDC_TOKEN_ID` |
...
| --- | --- | --- |
| Protocol CLI | `@agonx402/protocol-cli` | Read protocol state and prepare unsigned transactions/messages |
| Protocol MCP | `@agonx402/protocol-mcp` | Mirrored read/prepare tools plus `agon://protocol/llm.txt` |
| Skills repo | [github.com/Agonx402/agon-gateway-agentic](https://github.com/Agonx402/agon-gateway-agentic) | Gateway and protocol skills for agent runtimes |
