...
<CardGroup cols={2}>
  ...
  <Card title="TypeScript SDK" icon="code" href="/sdk">
    Integrate Agon with [`@agonx402/sdk`](https://www.npmjs.com/package/@agonx402/sdk) — typed client, PDA helpers, and message builders.
  </Card>
  ...
  <Card title="Agentic tools" icon="robot" href="/reference/agentic-tools">
    Skills, CLI, MCP, and LLM text for agents integrating Agon.
  </Card>
</CardGroup>
