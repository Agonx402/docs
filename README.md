...
- Protocol docs include the live devnet deployment, SDK guides, settlement modes, and [agentic tools](/reference/agentic-tools).
- Gateway docs include x402/SIWX integration, route catalog, pricing, and payment headers.
