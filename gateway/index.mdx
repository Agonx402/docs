...
- **Transparent pricing.** Every paid route advertises its exact USDC price up front — pulled directly from each upstream's public pay-as-you-go schedule, with no added spread.
