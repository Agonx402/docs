...
x402 paid routes settle in **USDC on Solana mainnet**. Agon channel routes are denominated in official **devnet USDC token amounts** and settle later through Agon Protocol bundle settlement.
...
## Agon channel pricing

For `/v1/agon-channel/...` routes, the catalog publishes token-denominated pricing:
