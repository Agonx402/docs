...
For Agon payment-channel routes under `/v1/agon-channel/...`, use the channel flow in [Access modes](/gateway/access-modes) and [Agentic tools](/reference/agentic-tools).
